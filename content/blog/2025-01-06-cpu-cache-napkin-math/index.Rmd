...
I liked [This resource](https://cs186berkeley.net/notes/note4/)
as an overview of B+ tree properties and implementation.
...
random accesses. Let $b$ be 2 times the order.


$$
\begin{align*}
\text{Height} &= \log_b(1,000,000) \\ 
