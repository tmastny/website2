...
knitr::opts_knit$set(root.dir = 'periodization-meta-analysis/')
```
```{r, echo=FALSE}
...
As expected, lots of missing data. Seemingly important data such as Program Label, Details, and participants. There is a temptation just to toss it out, but only studies 35 adn 47 are missing this data. We can easily go back to the source and see what's going on.
