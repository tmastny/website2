...
In general, how do we compare any two algorithms?
...
And insertion sort can even perform better when the list is "almost sorted"!
...
Whether one algorithm is better than another depends on the
context and the assumptions you make when analyzing them.
So let's make some assumptions and see how they hold up.
