...
I actually cleaned and tidied Greg's spreadsheet in a [previous blog post](https://timmastny.rbind.io/blog/tidying-messy-spreadsheets-dplyr/). Greg shared his version of the spreadsheet in his article, but all my analysis will start from [`tidied_periodization.csv`](https://github.com/tmastny/periodization-meta-analysis/blob/master/tidied_periodization.csv) found on the Github repo.
