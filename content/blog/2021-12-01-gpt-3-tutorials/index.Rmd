...
Getting a good response is very sensitive to the [prompt](https://www.gwern.net/GPT-3#prompts-as-programming).
Asking for a tutorial on dplyr in a general way produced
something that was recognizable as R but incoherent.
