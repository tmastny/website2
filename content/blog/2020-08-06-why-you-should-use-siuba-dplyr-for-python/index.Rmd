...
it also supports tab-completion in IPython and Jupyter Notebbooks
of column names and pandas data frame and series methods:
...
with lots of help from Michael Chow.
