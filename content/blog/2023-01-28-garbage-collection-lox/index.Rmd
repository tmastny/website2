...
(and the string isn't on the virtual machine's stack.)^[Other [folks](https://github.com/munificent/craftinginterpreters/issues/1068) were also confused by this example.]

It's true in an abstract sense that `"first value"` could be collected without
causing a problem, but the implementation works different:
