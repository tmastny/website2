...
For me, git submodules are preferrable to other local clones of your project's Github repo. First, I organizing the projects my blog uses within the website's directory structre. Second, submodules have an added layer of version control that handles project updates in a careful way. This helps to avoid breaking my posts due to a project update.
...
I like creating a subdirectory that will hold the submodules for any project: 
...
Lastly, you should also edit your `config.toml` file to ignore your `external_data` folder, or where ever you plan to put your submodules.
```{r, eval=FALSE}
