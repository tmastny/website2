...
> Note that this hazard detection logic works for "R-type" instructions
like `add`, `and`, etc. that write to registers, but not every
...
especially around data hazards with `lw` and `sw`. 
