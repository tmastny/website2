...
Additionally, the branch target offset was saved in the
...
and the compiler or programmer has the responsibility to fill.
...
many details about the prediction itself. 
