...
```{r}
blogdown::shortcode_html("highlight", "r", .content = 'urchins <- read_csv("https://tidymodels.org/start/models/urchins.csv") %>%
...
```{r}
blogdown::shortcode_html("highlight", "python", .content = "import pandas as pd
import numpy as np
