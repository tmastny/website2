---
title: Rmeotely connecting to Windows 10 with an iPad
author: ~
date: '2022-12-28'
...
with the ability to install OpenSSH directly. I found this 
[tutorial](https://www.hanselman.com/blog/how-to-ssh-into-a-windows-10-machine-from-linux-or-windows-or-anywhere) to work.
...
Lastly, before I jump to the iPad I recommend installing 
...
Next, inside Terminus, you'll need to generate connect to your server 
...
From there, run `code-server` to deploy your VSCode server.
